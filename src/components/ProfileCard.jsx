        ...
        <View style={GlobalStyles.image}>
          <View style={GlobalStyles.profitTop}>
            ...
            <TouchableOpacity
              ...
              style={GlobalStyles.profileTopButton}
            >
          ...
          <View style={GlobalStyles.profileBottom}>
            <View style={GlobalStyles.profileWrapper}>
              <Text style={GlobalStyles.profileBottomTextKey}>
                First Name:{" "}
              </Text>
              <Text style={GlobalStyles.profileBottomText}>
            ...
            <View style={GlobalStyles.profileWrapper}>
              ...
              <Text style={GlobalStyles.profileBottomText}>
                {userProfile && userProfile.user.last_name}
              </Text>
            </View>
            <View style={GlobalStyles.profileWrapper}>
            ...
            <View style={GlobalStyles.profileWrapper}>
              ...
              <Text style={GlobalStyles.profileBottomText}>
                {userProfile && userProfile.user.phone}
              </Text>
            </View>
